...
export default function Search() {
    ...
    return (
        <div
            ref={ref}
            className="min-h-[53px] mb-3 flex items-center sticky top-0 bg-black z-10">
            <label className="h-[43px] rounded-full bg-[#202327] w-full group border border-transparent focus-within:bg-black focus-within:border-[#1d9bf0]">
                ...
                <input
                    type="text"
                    className="w-full placeholder-[#71767b] h-full bg-transparent rounded-full outline-none pl-[56px] text-[15px]"
                    placeholder="Search"
                    value={query}
