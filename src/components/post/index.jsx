...
export default function Post({ post }) {
    return (
        <div className="px-4 gap-3 py-3 border-b border-[#212327] flex hover:bg-[#ffffff08] transition-colors">
            ...
            <div className="flex-1">
                ...
                <div className="flex -ml-1.5 mt-1.5">
                    <div className="flex-1 group flex items-center gap-px">
                        <div className="w-[2.172rem] h-[2.172rem] transition-colors flex items-center justify-center group-hover:bg-[#1b9bf01a] rounded-full group-hover:text-[#1d9bf0]">
                        ...
                        <span className="text-[0.813rem] transition-colors text-[#71767b] group-hover:text-[#1b9bf0]">{NumberFormat(post.stats.comments)}</span>
                    </div>
                    <div className="flex-1 group flex items-center gap-px">
                        <div
